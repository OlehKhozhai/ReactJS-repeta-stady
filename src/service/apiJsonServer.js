...
const addMenuItemByCategory = category =>
  category === 'all'
    ? getAllMenuItems()
    : axios.get(`http://localhost:3000/menu?category=${category}`).then(res => res.data);

export { getAllMenuItems, getMenuItemById, deleteMenuItem, addMenuItem, addMenuItemByCategory };
